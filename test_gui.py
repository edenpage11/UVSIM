...
class TestGui(unittest.TestCase):
    ...
    # 25: Blake Adamson - Testing that number buttons get put in textbox. Date: 12/9
    ...
    # 26: Blake Adamson - Test that edit_button_clear method will clear inputs and textbox. Date: 12/9
    ...
    # 27: Blake Adamson - Test that edit_button_delete removes inputs. Date: 12/9
    ...
    # 28: Blake Adamson - Test that "run" button calls "button_run" method once. Date: 12/9
    ...
    # 29: Blake Adamson - Test that "help" calls iconify method and opens helper window. Date: 12/9
    ...
    # 30: Blake Adamson - Test. Date: 12/9
    ...
    # 31: Blake Adamson - Test that file_warning triggers iconify and opens window. Date: 12/9
    ...
    # 32: Blake Adamson - Test that runIO method in Runner performes given operation. Date: 12/9
    ...
    # 33: Blake Adamson - Testing that GUI correctly displays title. Date:12/9
