...
class TestMain(unittest.TestCase):
    ...
    # 01: Eden Barlow - Testing read stores positive number in correct location in memory date: 9/25
    ...
    # 02: Eden Barlow - Testing read stores negative number in correct location in memory date: 9/25
    # input: '-1234' string // expected output: -1234 int // p/f: p
    @patch('builtins.input', side_effect=['-1234'])
